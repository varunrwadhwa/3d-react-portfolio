...
const Hero = () => {
  ...
  useEffect(()=>
  {
    init(textRef.current, { showCursor: true, strings: [' Software Engineer at GEP ', " React Expert ",' Mobile App Developer ', " AI Enthusiast " , " Expert Meditator ", " JavaScript Expert "] })
  },[]);

  return (
    <section className={`relative w-full h-screen mx-auto`}>
      <div className="flex">
        <div className={`head1 absolute  max-w-7xl mx-auto ${styles.paddingX} flex flex-row items-start gap-5`}>
          ...
          <div className="head2">
            ...
            <div className="absolute link1">
              <a
                href="https://x.com/CodeWithVarun" target="_blank">
                <AiOutlineTwitter />
              </a>
              <a
      ...
      {/* <ComputersCanvas /> */}
      {/* uncommnet this line to see the animation of the mac */}
